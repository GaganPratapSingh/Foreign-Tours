              ...
              <div id="carouselExampleSlidesOnly" className="carousel slide" data-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                     <img className="d-block w-100" src="Images/slidePic2.jpg" alt="First slide" style={{height:"50%"}}/>
                  </div>
                  <div className="carousel-item">
                     <img className="d-block w-100 " src="Images/slidePic1.jpg" alt="Second slide" style={{height:"auto"}}/>
                  </div>
                  <div className="carousel-item">
                     <img className="d-block w-100" src="Images/slidePic3.jpg" alt="Third slide" style={{height:"auto"}}/>
                  </div>
                </div>
               </div>
        </section>   
              ...
              <div className="row">
                 <div className="col-sm-4 mb-5">
                    <div className="card mt-4">
                       <img className="card-img-top" src="Images/Japan.jpg" alt=""/>
                 ...
                 <div className="col-sm-4 mb-5">
                    <div className="card mt-4">
                       <img className="card-img-top" src="Images/Tokyo.jpg" alt=""/>
                       <div className="card-body">
                 ...
                 <div className="col-sm-4 mb-5">
                    <div className="card mt-4">
                       <img className="card-img-top" src="Images/India.jpg" alt=""/>
                       <div className="card-body">
